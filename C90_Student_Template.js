...
function car2_up() {
	if(car2Y >=0) {
		car2Y = car2Y - 10;
		console.log("Quando a tecla W é pressionada, x = " + car2X + " | y = "+car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_down() {
	if(car2Y <=500) {
		car2Y = car2Y + 10;
		console.log("Quando a tecla S é pressionada, x = " + car2X + " | y = "+car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_left() {
	if(car2X >=0) {
		car2X = car2X - 10;
		console.log("Quando a tecla A é pressionada, x = " + car2X + " | y = "+car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
...
function car2_right() {
	if(car2X <=700) {
		car2X = car2X + 10;
		console.log("Quando a tecla D é pressionada, x = " + car2X + " | y = "+car2Y);
		uploadBackground();
		uploadcar1();
		uploadcar2();
	}
